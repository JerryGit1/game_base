 ...
 */
class MyButton extends BaseView{
    ...
    private touchBegin(e:egret.TouchEvent):void{
        ...
        egret.Tween.get(this.card).to({scaleX:this.sX+0.1,scaleY:this.sY+0.1},70);
    ...
    private touchEnd(e:egret.TouchEvent):void{
        ...
        egret.Tween.get(this.card).to({scaleX:this.sX,scaleY:this.sY},70).call(function () {
