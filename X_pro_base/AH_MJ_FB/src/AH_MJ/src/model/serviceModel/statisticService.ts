...
class AH_statisticService extends AH_baseService{
    ...
    /*单例*/
    private static service:AH_statisticService;
    ...
    /*统计*/
    /*登录统计*/
    private _isAddLogin=false;
    public login(){//u_id
        if(this._isAddLogin)return;
        ...
        // MyConsole.getInstance().trace("登陆次数统计**","custom3");
    }
    /*日活统计*/
    public login_UA(uid){
        this.http({
        ...
        //MyConsole.getInstance().trace("登录日活统计**","custom3");
    }
    /*房主房间统计*/
    ...
    * */
    ...
    public share(){
        ...
        // MyConsole.getInstance().trace("分享统计**","custom3");
    }
    // /*创建房间统计*/  2.0.8 舍弃
    // public createRoom(u_id){
    //     this.http({
    //         p_name:this.p_name,
    //         o_name:"u_cRoom",
    //         u_id:u_id
    ...
    //         s_count:s_count
    //     });
    //     MyConsole.getInstance().trace("消費房卡**","custom3");
    // }
    // /*大接口次数统计*/ 2.0.8 舍弃
    // public mainPortNum(u_id){
    //     this.http({
    //         p_name:this.p_name,
    //         o_name:"port_main",
    //         u_id:u_id
    ...
    /*---------------------------http*-------------------------------------*/
    protected http(data){
        if(this.getVersionType()=="demo")return;
