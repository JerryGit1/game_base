...
var AH_MyConsole = (function () {
        ...
        if (this._isTrace) {
            if (window["ah_tester"]) {
                ...
                if (this.currentVersionType == "release")
                    _isConsole = false;
                this.ah_tester.start(Main.pro_name, Main.version, 4, 1, true, v);
            }
        }
    };
    /**
     ...
     **/
    AH_MyConsole.prototype.trace = function (obj, type, name) {
...
__reflect(AH_MyConsole.prototype, "AH_MyConsole");
