 ...
 * 吃碰杠 牌
 */
var AH_Game_cpgCardView = (function (_super) {
    __extends(AH_Game_cpgCardView, _super);
    function AH_Game_cpgCardView() {
        var _this = _super.call(this) || this;
        _this.w = 0;
        _this.h = 0;
        _this.cpgCards = [];
        _this.twoPoint = new egret.Point(); /*第二张牌坐标*/
        _this.skewing = 0;
        _this.maxSkewing = 0;
        return _this;
    }
    /*数据显示视图*/
    AH_Game_cpgCardView.prototype.setCardData = function (model, position, w, skewing) {
        if (position === void 0) { position = 1; }
        if (w === void 0) { w = 0; }
        if (skewing === void 0) { skewing = 0; }
        if (model) {
            this.visible = true;
            ...
            if (this.cardStr != str) {
                ...
                switch (model.type) {
                    case 1:
                        ...
                        this.addChiOrPeng(position, w, newList);
                        break;
                    case 2:
    ...
    /*显示吃和碰*/
    AH_Game_cpgCardView.prototype.addChiOrPeng = function (position, w, list) {
        //显示通用3张
        this.addThreeCard(position, w, list);
    };
    /*显示和明杠暗杠*/
    AH_Game_cpgCardView.prototype.addMingOrAnGang = function (position, w, list) {
        //显示通用3张
        this.addThreeCard(position, w, list);
        //第四张放到 第二张位置
    ...
    /*显示小杠*/
    AH_Game_cpgCardView.prototype.addXiao = function (position, w, list, len) {
    ...
    /*-------------------------------------------------------*/
    /*显示前3张牌 吃 碰 杠都一样*/
    AH_Game_cpgCardView.prototype.addThreeCard = function (position, w, list) {
        var cardView, i, x = 0;
        var y = 0;
        for (i = 0; i < 3; i++) {
    ...
    /*创建一张牌*/
    AH_Game_cpgCardView.prototype.createCard = function (cardType, cardNum, w, position) {
        var bgType;
        if (cardNum == -1) {
            bgType = "ag_" + position;
        }
    ...
    /*清空老牌*/
    AH_Game_cpgCardView.prototype.clearOldCard = function () {
    ...
    return AH_Game_cpgCardView;
}(BaseView));
__reflect(AH_Game_cpgCardView.prototype, "AH_Game_cpgCardView");
